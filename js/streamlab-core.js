...
(function(jQuery) {
    ...
    var registerDependencies = function() {
            var PluginJsConfig = {
                "js_dependencies": {
                    "asyncloader.js": "front/js/vendor/asyncloader.js",
                    "asyncloader": "front/js/asyncloader.min.js?ver=1.0",
                    "circle-progress": "front/js/circle-progress.min.js?ver=1.0",
                    "isotope.pkgd": "front/js/isotope.pkgd.min.js?ver=1.0",
                    "jquery.countTo": "front/js/jquery.countTo.min.js?ver=1.0",
                    "jquery.magnific-popup": "/front/js/jquery.magnific-popup.min.js?ver=1.0",
                    "owl.carousel": "front/js/owl.carousel.min.js?ver=1.0",
                    "slick": "front/js/slick.min.js?ver=1.0"
                }
            };
